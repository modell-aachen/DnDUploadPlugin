...
(function($, _, document, window, undefined) {
    ...
    $(document).ready(function() {
        $(".qw-dnd-upload").each(function() {
            ...
            var input = [ '<input class="qw-file-input" data-id="', id, '" type="file" style="display: none" multiple="multiple">' ].join("");
            var $input = $(input);
            $input.appendTo($("body"));
    ...
    var uploadNext = function(id) {
        ...
        var keyurl = [ p.SCRIPTURLPATH, "/rest", p.SCRIPTTSUFFIX, "/DnDUploadPlugin/validation?topic=", wt.web, ".", wt.topic ].join("");
        var uploadurl = [ p.SCRIPTURLPATH, "/upload", p.SCRIPTTSUFFIX, "/", wt.web, ".", wt.topic ].join("");
